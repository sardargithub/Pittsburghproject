...
public class AddingtowishlistHeadless {
...
public void testwishlist() throws Exception
{
	...
	Commonclass.Threadtime3sec(driver, Clickshippingoption);
	...
	WebElement Clickwishlist= driver.findElement(By.xpath("//span[text()=' Add To WishList']"));
	JavascriptExecutor moveuptowishlist = (JavascriptExecutor) driver;
	moveuptowishlist.executeScript("arguments[0].click();", Clickwishlist);
	...
	WebElement clickonwishlist=driver.findElement(By.xpath("//*[text()='Wish List']"));
