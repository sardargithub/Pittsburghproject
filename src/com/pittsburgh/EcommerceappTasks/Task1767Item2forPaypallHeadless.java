...
public class Task1767Item2forPaypallHeadless {
	...
	//	WebElement loginbutton1st=driver.findElement(By.xpath("//a[text()=' Login']"));
	//	Commonclass.Click(driver, loginbutton1st);
	//	Commonclass.WaitForElementclickable(driver, loginbutton1st);
	...
	{
		String Testname="checkoutmodule";
	...
	/*    WebElement sendpaypalguest=driver.findElement(By.xpath("//*[text()='PayPal Guest Checkout']"));
		JavascriptExecutor moveuptopaypalguest = (JavascriptExecutor) driver;
		moveuptopaypalguest.executeScript("arguments[0].scrollIntoView();", sendpaypalguest);  */
		Thread.sleep(40000);
		WebElement sendcountry=	driver.findElement(By.xpath("//*[@id='country']"));
		Select colourofboot= new Select(sendcountry);
		...
		Commonclass.WaitForElementVisibility(driver, sendcountry);
