...
public class Task1920DashboardtestingHeadlessloginerror {
    ...
    System.setProperty("webdriver.chrome.driver","./Lib/Browsers/chromedriver.exe");	
		...
		WebElement clickonokay=driver.findElement(By.xpath("//*[text()='Okay'][1]"));
		Commonclass.Click(driver, clickonokay);
		...
		//WebElement clickonokay2=driver.findElement(By.xpath("//*[text()='Okay'][1]"));
		//Commonclass.Click(driver, clickonokay2);
...
public void Vinyl() throws Exception
{
    ...
    WebElement Clickonproduct1=driver.findElement(By.xpath("(//*[@class='mat-row ng-star-inserted'])[74]"));
    Commonclass.Click(driver, Clickonproduct1);
    Commonclass.Threadtime2sec(driver, Clickonproduct1);
...
public void QualityAsurance() throws Exception
{
	...
	WebElement clcik1stone=driver.findElement(By.xpath("(//tr[@class='mat-row ng-star-inserted'])[79]"));
