...
public class Task1921Tailoringissue {
...
public void Tailoring() throws Exception
{
   ...
   // Commonclass.WaitForElementclickable(driver, clickonAllwork);
	...
	WebElement clicknewproduct=driver.findElement(By.xpath("(//tr[@class='mat-row ng-star-inserted'])[24]"));
	...
	WebElement clicknewassignedproduct=driver.findElement(By.xpath("(//tr[@class='mat-row ng-star-inserted'])[24]"));
	...
	WebElement clickonshirt= driver.findElement(By.xpath("//*[@class='mat-cell cdk-column-product mat-column-product ng-star-inserted']"));
...
public void Embroidery() throws Exception
{
    ...
    moveuptosortbutton.executeScript("arguments[0].click();", clickonsortbutton);
    Commonclass.Threadtime5sec(driver, clickonsortbutton);
    WebElement Clickonproduct1=driver.findElement(By.xpath("(//*[@class='mat-row ng-star-inserted'])[44]"));
    Commonclass.Click(driver, Clickonproduct1);
    WebElement clickonViewdetails=driver.findElement(By.xpath("//span[text()='View Details']"));
    Commonclass.Click(driver, clickonViewdetails);
   // Commonclass.Threadtime5sec(driver, clickonViewdetails);
    Thread.sleep(5000);
	WebElement clcikshirt=driver.findElement(By.xpath("(//*[@class='mat-cell cdk-column-product mat-column-product ng-star-inserted'])[2]"));
	Commonclass.Click(driver, clcikshirt);
	WebElement clickbegin=driver.findElement(By.xpath("//ion-button[text()='Begin']"));
	Commonclass.Click(driver, clickbegin);
	WebElement clickcomplete=driver.findElement(By.xpath("//ion-button[text()='Complete ']"));
...
public void print() throws Exception
{
	...
	moveuptoembroidery.executeScript("arguments[0].click();", clickEmbroiderey);
	Commonclass.Threadtime3sec(driver, clickEmbroiderey);
    WebElement Clickonproduct1=driver.findElement(By.xpath("(//*[@class='mat-row ng-star-inserted'])[65]"));
    Commonclass.Click(driver, Clickonproduct1);
   // Commonclass.Threadtime5sec(driver, Clickonproduct1);  
    Thread.sleep(5000);
	WebElement clcikshirt=driver.findElement(By.xpath("(//*[@class='mat-cell cdk-column-product mat-column-product ng-star-inserted'])[3]"));
	Commonclass.Click(driver, clcikshirt);
	WebElement clickbegin=driver.findElement(By.xpath("//ion-button[text()='Begin']"));
	Commonclass.Click(driver, clickbegin);
	WebElement clickcomplete=driver.findElement(By.xpath("//ion-button[text()='Complete ']")); 
...
public void Vinyl() throws Exception
{
    ...
    WebElement Clickonproduct1=driver.findElement(By.xpath("(//*[@class='mat-row ng-star-inserted'])[76]"));
    Commonclass.Click(driver, Clickonproduct1);
   // Commonclass.Threadtime5sec(driver, Clickonproduct1);
    Thread.sleep(5000);
	WebElement clcikshirt=driver.findElement(By.xpath("(//*[@class='mat-cell cdk-column-product mat-column-product ng-star-inserted'])[4]"));
	Commonclass.Click(driver, clcikshirt);
	WebElement clickbegin=driver.findElement(By.xpath("//ion-button[text()='Begin']"));
	Commonclass.Click(driver, clickbegin);
	WebElement clickcomplete=driver.findElement(By.xpath("//ion-button[text()='Complete ']")); 
...
public void QualityAsurance() throws Exception
{
	...
	WebElement clcik1stone=driver.findElement(By.xpath("(//tr[@class='mat-row ng-star-inserted'])[83]"));
	Commonclass.Click(driver, clcik1stone);
	//Commonclass.Threadtime5sec(driver, clcik1stone);
	Thread.sleep(5000);
	WebElement clickshirt=driver.findElement(By.xpath("(//*[@class='mat-cell cdk-column-product mat-column-product ng-star-inserted'])[5]"));
